...
describe("POST/api/articles/:article_id/comments", () => {
  test("201: Returns the posted comment object", () => {
    ...
    return request(app)
      ...
      .then(({ body }) => {
        ...
        expect(body.postedComment).toHaveProperty(
          "body",
          "pretty reductive, honestly"
        );
        expect(body.postedComment).toHaveProperty(
          "comment_id",
          expect.any(Number)
  ...
  test(`400: responds with a bad request error when given a non-number article_id param`, () => {
    const newComment = {
      username: "butter_bridge",
      body: "pretty bad request, honestly",
    };
    return request(app)
...
describe("PATCH/api/articles/:article_id", () => {
  ...
  test("200: responds with the updated article when given a bloated object which contains inc_votes, along with additional properties. The additional properties should be ignored and the votes property should be updated correctly", () => {
    const articleVotes = {
      ...
      inc_votes: 800,
      abc: "def",
      body: "trying to change the body when I shouldnt be able to hahaha",
    };
    return request(app)
      .patch("/api/articles/1")
      .send(articleVotes)
  ...
  test(`200: updates the given comment's votes and returns the updated comment`, () => {
    ...
    return request(app)
      ...
      .then(({ body }) => {
        ...
        expect(body.updatedComment).toHaveProperty(
          "author",
          expect.any(String)
        );
        expect(body.updatedComment).toHaveProperty(
...
describe("POST/api/articles", () => {
  test("200: responds with newly created article object", () => {
    const newArticle = {
      author: "butter_bridge",
    ...
    return request(app)
      ...
      .expect(200)
      .then(({ body }) => {
        expect(Object.keys(body.createdArticle).length).toBe(9);
        expect(body.createdArticle).toHaveProperty("author", "butter_bridge");
        expect(body.createdArticle).toHaveProperty(
          "title",
          "Lorem ipsum dolor sit amet"
        );
        expect(body.createdArticle).toHaveProperty(
          "body",
          "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mollis ultrices feugiat. Phasellus vel ipsum ac purus feugiat finibus ut quis erat."
        );
        expect(body.createdArticle).toHaveProperty(
          "article_img_url",
          "www.google.com"
        );
        expect(body.createdArticle).toHaveProperty("topic", "mitch");
        expect(body.createdArticle).toHaveProperty(
          "article_id",
          expect.any(Number)
        );
        expect(body.createdArticle).toHaveProperty("votes", expect.any(Number));
        expect(body.createdArticle).toHaveProperty(
          "created_at",
          expect.any(String)
        );
        expect(body.createdArticle).toHaveProperty("comment_count", 0);
      });
  });
  test("200: defaults article_img_url if not given in the body", () => {
    const newArticle = {
      author: "butter_bridge",
      title: "Lorem ipsum dolor sit amet",
      body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mollis ultrices feugiat. Phasellus vel ipsum ac purus feugiat finibus ut quis erat.",
  ...
  test('200: responds with the created article when given a bloated object which contains the required, along with additional properties. The additional properties should be ignored and the article should be created and returned', () => {
    const newArticle = {
      author: "butter_bridge",
      title: "Lorem ipsum dolor sit amet",
      body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mollis ultrices feugiat. Phasellus vel ipsum ac purus feugiat finibus ut quis erat.",
  ...
  test("400: responds with a bad request error when given a request body missing any of the required fields", () => {
    const newArticle = {
      author: "butter_bridge",
      title: "Lorem ipsum dolor sit amet",
      body: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent mollis ultrices feugiat. Phasellus vel ipsum ac purus feugiat finibus ut quis erat.",
